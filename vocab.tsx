...
const DEFAULT_VOCAB = [
  // Stage 1
  {
    en: "achieve",
    ja: "Aを達成する",
    sentence: "She achieved her goal of becoming a doctor.",
    stage: 1,
    category: "英単語",
  },
  {
    en: "individual",
    ja: "個人の",
    sentence: "Each individual has different opinions.",
    stage: 1,
    category: "英単語",
  },
  {
    en: "significant",
    ja: "重要な",
    sentence: "There is a significant difference between them.",
    stage: 1,
    category: "英単語",
  },
  {
    en: "perspective",
    ja: "観点、見方",
    sentence: "We should look at it from a different perspective.",
    stage: 1,
    category: "英単語",
  },
  {
    en: "contribute",
    ja: "貢献する",
    sentence: "He contributed a lot of money to the charity.",
    stage: 1,
    category: "英単語",
  },
  {
    en: "evidence",
    ja: "証拠",
    sentence: "There is no evidence to support his theory.",
    stage: 1,
    category: "英単語",
  },
  {
    en: "consequence",
    ja: "結果",
    sentence: "You must accept the consequences of your actions.",
    stage: 1,
    category: "英単語",
  },
  {
    en: "opportunity",
    ja: "機会",
    sentence: "Don't miss the opportunity to study abroad.",
    stage: 1,
    category: "英単語",
  },
  {
  ...
  // Stage 2
  {
    en: "appropriate",
    ja: "適切な",
    sentence: "His behavior was not appropriate for the occasion.",
    stage: 2,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "indicate",
    ja: "Aを指し示す",
    sentence: "The survey indicates that people are unhappy.",
    stage: 2,
    category: "英単語",
  },
  {
    en: "specific",
    ja: "特定の",
    sentence: "Can you give me a specific example?",
    stage: 2,
    category: "英単語",
  },
  {
    en: "establish",
    ja: "Aを設立する",
    sentence: "The company was established in 1950.",
    stage: 2,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "resource",
    ja: "資源",
    sentence: "Japan is poor in natural resources.",
    stage: 2,
    category: "英単語",
  },
  {
    en: "participate",
    ja: "参加する",
    sentence: "Many students participated in the discussion.",
    stage: 2,
    category: "英単語",
  },
  {
    en: "identify",
    ja: "Aを特定する",
    sentence: "She identified the man as the thief.",
    stage: 2,
    category: "英単語",
  },
  {
    en: "structure",
    ja: "構造",
    sentence: "They studied the structure of the brain.",
    stage: 2,
    category: "英単語",
  },
  // Stage 3
  {
    en: "previous",
    ja: "前の",
    sentence: "I have no previous experience in this field.",
    stage: 3,
    category: "英単語",
  },
  {
    en: "consumer",
    ja: "消費者",
    sentence: "Consumer demand for electric cars is rising.",
    stage: 3,
    category: "英単語",
  },
  {
    en: "complex",
    ja: "複雑な",
    sentence: "The problem is too complex to solve easily.",
    stage: 3,
    category: "英単語",
  },
  {
    en: "obtain",
    ja: "Aを得る",
    sentence: "You can obtain more information online.",
    stage: 3,
    category: "英単語",
  },
  {
    en: "potential",
    ja: "潜在的な",
    sentence: "The new technology has great potential.",
    stage: 3,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "affect",
    ja: "Aに影響を与える",
    sentence: "The weather affects our travel plans.",
    stage: 3,
    category: "英単語",
  },
  {
    en: "effective",
    ja: "効果的な",
    sentence: "This is an effective way to learn English.",
    stage: 3,
    category: "英単語",
  },
  {
    en: "require",
    ja: "Aを必要とする",
    sentence: "The task requires a lot of patience.",
    stage: 3,
    category: "英単語",
  },
  {
  ...
  // Stage 4
  {
    en: "attitude",
    ja: "態度",
    sentence: "He has a positive attitude toward life.",
    stage: 4,
    category: "英単語",
  },
  {
    en: "aspect",
    ja: "側面",
    sentence: "We need to consider every aspect of the plan.",
    stage: 4,
    category: "英単語",
  },
  {
    en: "feature",
    ja: "特徴",
    sentence: "The main feature of this phone is its camera.",
    stage: 4,
    category: "英単語",
  },
  {
    en: "concept",
    ja: "概念",
    sentence: "It is difficult to grasp the concept of time.",
    stage: 4,
    category: "英単語",
  },
  {
    en: "promote",
    ja: "Aを促進する",
    sentence: "The government is promoting tourism.",
    stage: 4,
    category: "英単語",
  },
  {
    en: "relevant",
    ja: "関連のある",
    sentence: "His comments were not relevant to the topic.",
    stage: 4,
    category: "英単語",
  },
  {
    en: "various",
    ja: "さまざまな",
    sentence: "We have various options for the weekend.",
    stage: 4,
    category: "英単語",
  },
  {
    en: "estimate",
    ja: "Aを推定する",
    sentence: "They estimate that the project will take a year.",
    stage: 4,
    category: "英単語",
  },
  {
    en: "access",
    ja: "接近、利用権",
    sentence: "Everyone should have access to education.",
    stage: 4,
    category: "英単語",
  },
  {
    en: "principle",
    ja: "原理、原則",
    sentence: "It is a basic principle of democracy.",
    stage: 4,
    category: "英単語",
  },
  // Stage 5
  {
    en: "contrast",
    ja: "対照",
    sentence: "There is a sharp contrast between the two.",
    stage: 5,
    category: "英単語",
  },
  {
    en: "strategy",
    ja: "戦略",
    sentence: "We need a new strategy to win the game.",
    stage: 5,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "element",
    ja: "要素",
    sentence: "Water is an essential element for life.",
    stage: 5,
    category: "英単語",
  },
  {
    en: "evaluate",
    ja: "Aを評価する",
    sentence: "It is hard to evaluate his performance.",
    stage: 5,
    category: "英単語",
  },
  {
    en: "impact",
    ja: "影響、衝撃",
    sentence: "The move had a negative impact on her health.",
    stage: 5,
    category: "英単語",
  },
  {
    en: "purchase",
    ja: "Aを購入する",
    sentence: "You can purchase tickets at the gate.",
    stage: 5,
    category: "英単語",
  },
  {
    en: "rely",
    ja: "頼る",
    sentence: "We rely heavily on the Internet.",
    stage: 5,
    category: "英単語",
  },
  {
    en: "status",
    ja: "地位、状態",
    sentence: "She achieved high social status.",
    stage: 5,
    category: "英単語",
  },
  {
    en: "unique",
    ja: "独特の",
    sentence: "Every person has a unique personality.",
    stage: 5,
    category: "英単語",
  },
  // Stage 6
  {
    en: "acquire",
    ja: "Aを習得する",
    sentence: "It takes time to acquire a new language.",
    stage: 6,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "capable",
    ja: "能力がある",
    sentence: "He is capable of doing the job alone.",
    stage: 6,
    category: "英単語",
  },
  {
    en: "capacity",
    ja: "収容能力、能力",
    sentence: "The theater has a capacity of 500 people.",
    stage: 6,
    category: "英単語",
  },
  {
    en: "challenge",
    ja: "挑戦",
    sentence: "Learning a new skill is a great challenge.",
    stage: 6,
    category: "英単語",
  },
  {
    en: "circumstance",
    ja: "状況、事情",
    sentence: "Under the circumstances, we had no choice.",
    stage: 6,
    category: "英単語",
  },
  {
    en: "conflict",
    ja: "紛争、葛藤",
    sentence: "There was a conflict between the two nations.",
    stage: 6,
    category: "英単語",
  },
  {
    en: "corporation",
    ja: "企業",
    sentence: "He works for a large international corporation.",
    stage: 6,
    category: "英単語",
  },
  {
    en: "criteria",
    ja: "基準",
    sentence: "What are the criteria for success?",
    stage: 6,
    category: "英単語",
  },
  {
    en: "decade",
    ja: "10年間",
    sentence: "Many changes occurred in the last decade.",
    stage: 6,
    category: "英単語",
  },
  // Stage 7
  {
    en: "demonstrate",
    ja: "Aを証明する、実演する",
    sentence: "He demonstrated how to use the machine.",
    stage: 7,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "device",
    ja: "装置、機器",
    sentence: "A smartphone is a useful device.",
    stage: 7,
    category: "英単語",
  },
  {
    en: "dimension",
    ja: "寸法、次元",
    sentence: "They measured the dimensions of the room.",
    stage: 7,
    category: "英単語",
  },
  {
    en: "distinct",
    ja: "はっきり異なる",
    sentence: "There is a distinct difference in their styles.",
    stage: 7,
    category: "英単語",
  },
  {
    en: "distribute",
    ja: "Aを分配する",
    sentence: "The leaflets were distributed to the crowd.",
    stage: 7,
    category: "英単語",
  },
  {
    en: "domestic",
    ja: "国内の、家庭の",
    sentence: "We should support domestic products.",
    stage: 7,
    category: "英単語",
  },
  {
    en: "emerge",
    ja: "現れる",
    sentence: "A new problem emerged after the meeting.",
    stage: 7,
    category: "英単語",
  },
  {
    en: "emphasize",
    ja: "Aを強調する",
    sentence: "She emphasized the importance of safety.",
    stage: 7,
    category: "英単語",
  },
  // Stage 8
  {
    en: "ensure",
    ja: "Aを確実にする",
    sentence: "Please ensure that all the windows are closed.",
    stage: 8,
    category: "英単語",
  },
  {
    en: "equivalent",
    ja: "同等の",
    sentence: "One dollar is equivalent to about 150 yen.",
    stage: 8,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "expand",
    ja: "拡大する",
    sentence: "The company is expanding its business.",
    stage: 8,
    category: "英単語",
  },
  {
    en: "exposure",
    ja: "露出、さらされること",
    sentence: "Exposure to sunlight can damage the skin.",
    stage: 8,
    category: "英単語",
  },
  {
    en: "external",
    ja: "外部の",
    sentence: "The computer has an external hard drive.",
    stage: 8,
    category: "英単語",
  },
  {
    en: "facility",
    ja: "施設、設備",
    sentence: "The school has excellent sports facilities.",
    stage: 8,
    category: "英単語",
  },
  {
    en: "factor",
    ja: "要因",
    sentence: "Diet is a major factor in health.",
    stage: 8,
    category: "英単語",
  },
  {
    en: "generate",
    ja: "Aを生み出す",
    sentence: "The wind farm generates electricity.",
    stage: 8,
    category: "英単語",
  },
  {
    en: "global",
    ja: "地球規模の",
    sentence: "Pollution is a global problem.",
    stage: 8,
    category: "英単語",
  },
  // Stage 9
  {
    en: "hypothesis",
    ja: "仮説",
    sentence: "Scientists are testing the new hypothesis.",
    stage: 9,
    category: "英単語",
  },
  {
    en: "ignore",
    ja: "Aを無視する",
    sentence: "You should not ignore the warning signs.",
    stage: 9,
    category: "英単語",
  },
  {
    en: "illustrate",
    ja: "Aを説明する",
    sentence: "He used a story to illustrate his point.",
    stage: 9,
    category: "英単語",
  },
  {
    en: "imply",
    ja: "Aを暗に意味する",
    sentence: "His silence implies that he agrees.",
    stage: 9,
    category: "英単語",
  },
  {
    en: "incentive",
    ja: "動機、刺激",
    sentence: "Money is a powerful incentive for work.",
    stage: 9,
    category: "英単語",
  },
  {
    en: "income",
    ja: "収入",
    sentence: "They have a steady monthly income.",
    stage: 9,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "influence",
    ja: "Aに影響を与える",
    sentence: "Parents influence their children's behavior.",
    stage: 9,
    category: "英単語",
  },
  {
    en: "infrastructure",
    ja: "社会基盤（インフラ）",
    sentence: "The city needs better infrastructure.",
    stage: 9,
    category: "英単語",
  },
  {
    en: "initiate",
    ja: "Aを開始する",
    sentence: "The company initiated a new project.",
    stage: 9,
    category: "英単語",
  },
  // Stage 10
  {
    en: "innovation",
    ja: "革新",
    sentence: "Technological innovation changes our lives.",
    stage: 10,
    category: "英単語",
  },
  {
    en: "insight",
    ja: "洞察力",
    sentence: "She has a deep insight into human nature.",
    stage: 10,
    category: "英単語",
  },
  {
    en: "instance",
    ja: "例",
    sentence: "For instance, you could try exercise.",
    stage: 10,
    category: "英単語",
  },
  {
    en: "integrate",
    ja: "Aを統合する",
    sentence: "The new system integrates various functions.",
    stage: 10,
    category: "英単語",
  },
  {
    en: "intelligence",
    ja: "知能",
    sentence: "He has high intelligence and creativity.",
    stage: 10,
    category: "英単語",
  },
  {
    en: "internal",
    ja: "内部の",
    sentence: "The project was for internal use only.",
    stage: 10,
    category: "英単語",
  },
  {
    en: "interpret",
    ja: "Aを解釈する",
    sentence: "It's difficult to interpret the results.",
    stage: 10,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "investment",
    ja: "投資",
    sentence: "Real estate can be a good investment.",
    stage: 10,
    category: "英単語",
  },
  {
    en: "justify",
    ja: "Aを正当化する",
    sentence: "How can you justify such a high cost?",
    stage: 10,
    category: "英単語",
  },
  // Stage 11
  {
    en: "objective",
    ja: "客観的な",
    sentence: "It is important to have an objective opinion.",
    stage: 11,
    category: "英単語",
  },
  {
    en: "alternative",
    ja: "代わりの、選択肢",
    sentence: "Do you have an alternative plan for the trip?",
    stage: 11,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "assess",
    ja: "Aを評価する",
    sentence: "The teacher assessed the students' progress.",
    stage: 11,
    category: "英単語",
  },
  {
    en: "assumption",
    ja: "仮定、思い込み",
    sentence: "His theory is based on a false assumption.",
    stage: 11,
    category: "英単語",
  },
  {
    en: "clarify",
    ja: "Aを明らかにする",
    sentence: "Could you clarify your last statement?",
    stage: 11,
    category: "英単語",
  },
  {
    en: "community",
    ja: "地域社会",
    sentence: "We should contribute to our local community.",
    stage: 11,
    category: "英単語",
  },
  {
    en: "component",
    ja: "構成要素",
    sentence: "Trust is a vital component of friendship.",
    stage: 11,
    category: "英単語",
  },
  {
    en: "convention",
    ja: "慣習、大会",
    sentence: "Social conventions vary from culture to culture.",
    stage: 11,
    category: "英単語",
  },
  {
    en: "coordinate",
    ja: "Aを調整する",
    sentence: "We need to coordinate our efforts.",
    stage: 11,
    category: "英単語",
  },
  // Stage 12
  {
    en: "core",
    ja: "核心、芯",
    sentence: "The core of the problem is a lack of money.",
    stage: 12,
    category: "英単語",
  },
  {
    en: "corporate",
    ja: "企業の",
    sentence: "Corporate profits have increased this year.",
    stage: 12,
    category: "英単語",
  },
  {
    en: "correspond",
    ja: "一致する、連絡し合う",
    sentence: "His actions do not correspond with his words.",
    stage: 12,
    category: "英単語",
  },
  {
    en: "credit",
    ja: "信用、称賛",
    sentence: "He deserves credit for his hard work.",
    stage: 12,
    category: "英単語",
  },
  {
    en: "deduce",
    ja: "Aを推論する",
    sentence: "What can we deduce from these facts?",
    stage: 12,
    category: "英単語",
  },
  {
    en: "define",
    ja: "Aを定義する",
    sentence: "How do you define success?",
    stage: 12,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "document",
    ja: "文書",
    sentence: "Please sign this official document.",
    stage: 12,
    category: "英単語",
  },
  {
    en: "dominant",
    ja: "支配的な、有力な",
    sentence: "English is a dominant language in business.",
    stage: 12,
    category: "英単語",
  },
  {
    en: "emphasis",
    ja: "強調",
    sentence: "The school puts emphasis on creativity.",
    stage: 12,
    category: "英単語",
  },
  // Stage 13
  {
    en: "ethnic",
    ja: "民族の",
    sentence: "There are many ethnic groups in this city.",
    stage: 13,
    category: "英単語",
  },
  {
    en: "exclude",
    ja: "Aを除外する",
    sentence: "Taxes are excluded from the price.",
    stage: 13,
    category: "英単語",
  },
  {
    en: "framework",
    ja: "枠組み",
    sentence: "This provides a framework for future research.",
    stage: 13,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "fundamental",
    ja: "根本的な",
    sentence: "Freedom is a fundamental human right.",
    stage: 13,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "immigration",
    ja: "移住、入国管理",
    sentence: "Immigration is a sensitive political issue.",
    stage: 13,
    category: "英単語",
  },
  {
    en: "implement",
    ja: "Aを実行する",
    sentence: "The new law will be implemented next month.",
    stage: 13,
    category: "英単語",
  },
  {
    en: "impose",
    ja: "Aを課す、押しつける",
    sentence: "The government imposed a new tax on oil.",
    stage: 13,
    category: "英単語",
  },
  {
    en: "interact",
    ja: "相互に作用する",
    sentence: "Children need to interact with each other.",
    stage: 13,
    category: "英単語",
  },
  // Stage 14
  {
    en: "label",
    ja: "ラベル、を分類する",
    sentence: "Read the label before taking the medicine.",
    stage: 14,
    category: "英単語",
  },
  {
    en: "layer",
    ja: "層",
    sentence: "There was a thick layer of dust on the table.",
    stage: 14,
    category: "英単語",
  },
  {
    en: "lecture",
    ja: "講義",
    sentence: "I attended a lecture on Japanese history.",
    stage: 14,
    category: "英単語",
  },
  {
    en: "legal",
    ja: "法律の、合法の",
    sentence: "You should seek legal advice.",
    stage: 14,
    category: "英単語",
  },
  {
    en: "liberal",
    ja: "自由主義の、寛大な",
    sentence: "He has liberal views on education.",
    stage: 14,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "logic",
    ja: "論理",
    sentence: "I don't understand the logic of his argument.",
    stage: 14,
    category: "英単語",
  },
  {
    en: "margin",
    ja: "余白、差",
    sentence: "Write your notes in the margin.",
    stage: 14,
    category: "英単語",
  },
  {
    en: "maximize",
    ja: "Aを最大にする",
    sentence: "We must maximize our resources.",
    stage: 14,
    category: "英単語",
  },
  {
    en: "mechanism",
    ja: "仕組み、装置",
    sentence: "The mechanism of the clock is broken.",
    stage: 14,
    category: "英単語",
  },
  // Stage 15
  {
    en: "medical",
    ja: "医学の",
    sentence: "He is a student at a medical school.",
    stage: 15,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "method",
    ja: "方法",
    sentence: "What is the best method for learning kanji?",
    stage: 15,
    category: "英単語",
  },
  {
    en: "migrate",
    ja: "移住する、渡る",
    sentence: "Birds migrate south in the winter.",
    stage: 15,
    category: "英単語",
  },
  {
    en: "military",
    ja: "軍の、軍隊",
    sentence: "He decided to join the military.",
    stage: 15,
    category: "英単語",
  },
  {
    en: "minor",
    ja: "小さい方の、重要でない",
    sentence: "I made a few minor mistakes in the test.",
    stage: 15,
    category: "英単語",
  },
  {
    en: "mode",
    ja: "方式、形態",
    sentence: "Trains are a common mode of transport.",
    stage: 15,
    category: "英単語",
  },
  {
    en: "monitor",
    ja: "Aを監視する",
    sentence: "The doctor monitored her heart rate.",
    stage: 15,
    category: "英単語",
  },
  {
    en: "negative",
    ja: "否定的な、負の",
    sentence: "Stress can have a negative effect on your health.",
    stage: 15,
    category: "英単語",
  },
  {
    en: "network",
    ja: "ネットワーク、網",
    sentence: "The rail network covers the whole country.",
    stage: 15,
    category: "英単語",
  },
  // Stage 16
  {
    en: "notion",
    ja: "概念、考え",
    sentence: "He has a strange notion about happiness.",
    stage: 16,
    category: "英単語",
  },
  {
    en: "nuclear",
    ja: "核の、原子力の",
    sentence: "The country depends on nuclear power.",
    stage: 16,
    category: "英単語",
  },
  {
    en: "occupy",
    ja: "Aを占める",
    sentence: "Reading occupies most of my free time.",
    stage: 16,
    category: "英単語",
  },
  {
    en: "occur",
    ja: "起こる",
    sentence: "Earthquakes occur frequently in Japan.",
    stage: 16,
    category: "英単語",
  },
  {
    en: "option",
    ja: "選択肢",
    sentence: "We have no other option but to wait.",
    stage: 16,
    category: "英単語",
  },
  {
    en: "orientation",
    ja: "方向付け、適応",
    sentence: "The new students attended an orientation.",
    stage: 16,
    category: "英単語",
  },
  {
    en: "outcome",
    ja: "結果",
    sentence: "We are waiting for the outcome of the election.",
    stage: 16,
    category: "英単語",
  },
  {
    en: "parallel",
    ja: "平行な、類似した",
    sentence: "The two roads are parallel to each other.",
    stage: 16,
    category: "英単語",
  },
  {
    en: "parameter",
    ja: "範囲、限界",
    sentence: "We must stay within the parameters of the budget.",
    stage: 16,
    category: "英単語",
  },
  {
    en: "partner",
    ja: "パートナー",
    sentence: "They have been business partners for years.",
    stage: 16,
    category: "英単語",
  },
  // Stage 17
  {
    en: "passive",
    ja: "受動的な",
    sentence: "He played a passive role in the meeting.",
    stage: 17,
    category: "英単語",
  },
  {
    en: "perceive",
    ja: "Aを知覚する",
    sentence: "People perceive things in different ways.",
    stage: 17,
    category: "英単語",
  },
  {
    en: "period",
    ja: "期間",
    sentence: "The museum is closed for a short period.",
    stage: 17,
    category: "英単語",
  },
  {
    en: "persist",
    ja: "固執する、持続する",
    sentence: "If the pain persists, see a doctor.",
    stage: 17,
    category: "英単語",
  },
  {
    en: "phase",
    ja: "段階",
    sentence: "We are entering a new phase of the project.",
    stage: 17,
    category: "英単語",
  },
  {
    en: "philosophy",
    ja: "哲学",
    sentence: "She is studying Greek philosophy.",
    stage: 17,
    category: "英単語",
  },
  {
    en: "physical",
    ja: "身体の、物理的な",
    sentence: "Physical exercise is good for your health.",
    stage: 17,
    category: "英単語",
  },
  {
    en: "policy",
    ja: "政策、方針",
    sentence: "The company has a strict privacy policy.",
    stage: 17,
    category: "英単語",
  },
  {
    en: "positive",
    ja: "前向きな、正の",
    sentence: "Try to stay positive even in difficult times.",
    stage: 17,
    category: "英単語",
  },
  {
    en: "precise",
    ja: "正確な",
    sentence: "Can you be more precise about the time?",
    stage: 17,
    category: "英単語",
  },
  // Stage 18
  ...
  },
  {
    en: "primary",
    ja: "最も重要な、初等の",
    sentence: "Our primary concern is the safety of the children.",
    stage: 18,
    category: "英単語",
  },
  {
    en: "prime",
    ja: "最も重要な、全盛期",
    sentence: "The prime suspect was arrested yesterday.",
    stage: 18,
    category: "英単語",
  },
  {
    en: "priority",
    ja: "優先事項",
    sentence: "Education is a high priority for the government.",
    stage: 18,
    category: "英単語",
  },
  {
    en: "professional",
    ja: "専門的な、プロの",
    sentence: "She gave me some professional advice.",
    stage: 18,
    category: "英単語",
  },
  {
    en: "project",
    ja: "計画、事業",
    sentence: "They are working on a new research project.",
    stage: 18,
    category: "英単語",
  },
  {
    en: "proportion",
    ja: "割合",
    sentence: "A large proportion of students work part-time.",
    stage: 18,
    category: "英単語",
  },
  {
    en: "prospect",
    ja: "見込み",
    sentence: "There is little prospect of an immediate recovery.",
    stage: 18,
    category: "英単語",
  },
  {
    en: "psychology",
    ja: "心理学",
    sentence: "He is interested in child psychology.",
    stage: 18,
    category: "英単語",
  },
  {
    en: "publish",
    ja: "Aを出版する",
    sentence: "The book was published last year.",
    stage: 18,
    category: "英単語",
  },
  // Stage 19
  {
    en: "quote",
    ja: "Aを引用する",
    sentence: "He quoted a famous poem in his speech.",
    stage: 19,
    category: "英単語",
  },
  {
    en: "range",
    ja: "範囲",
    sentence: "The prices range from $10 to $50.",
    stage: 19,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "recovery",
    ja: "回復",
    sentence: "He made a full recovery after the surgery.",
    stage: 19,
    category: "英単語",
  },
  {
    en: "reform",
    ja: "改革",
    sentence: "The government is planning a tax reform.",
    stage: 19,
    category: "英単語",
  },
  {
    en: "region",
    ja: "地域",
    sentence: "This region is known for its beautiful lakes.",
    stage: 19,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "regulate",
    ja: "Aを規制する、調整する",
    sentence: "The valve regulates the flow of water.",
    stage: 19,
    category: "英単語",
  },
  {
    en: "reinforce",
    ja: "Aを強化する",
    sentence: "They used steel to reinforce the bridge.",
    stage: 19,
    category: "英単語",
  },
  // Stage 20
  {
    en: "reject",
    ja: "Aを拒絶する",
    sentence: "She rejected his offer of help.",
    stage: 20,
    category: "英単語",
  },
  {
    en: "relax",
    ja: "くつろぐ",
    sentence: "I like to relax by reading a book.",
    stage: 20,
    category: "英単語",
  },
  {
    en: "release",
    ja: "Aを放出する、発売する",
    sentence: "The movie will be released next Friday.",
    stage: 20,
    category: "英単語",
  },
  {
    en: "relevant",
    ja: "関連のある",
    sentence: "His experience is relevant to this job.",
    stage: 20,
    category: "英単語",
  },
  {
    en: "rely",
    ja: "頼る",
    sentence: "You can't always rely on your parents.",
    stage: 20,
    category: "英単語",
  },
  {
    en: "remove",
    ja: "Aを取り除く",
    sentence: "Please remove your shoes at the entrance.",
    stage: 20,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "result",
    ja: "結果",
    sentence: "The result of the experiment was surprising.",
    stage: 20,
    category: "英単語",
  },
  {
    en: "review",
    ja: "Aを復習する",
    sentence: "You should review what you have learned.",
    stage: 20,
    category: "英単語",
  },
  {
    en: "provide",
    ja: "Aを提供する",
    sentence: "The government provides free education for all children.",
    stage: 21,
    category: "英単語",
  },
  {
    en: "consider",
    ja: "Aを考慮する",
    sentence: "Please consider all the options before making a decision.",
    stage: 21,
    category: "英単語",
  },
  {
    en: "avoid",
    ja: "Aを避ける",
    sentence: "You should avoid eating too much sugar.",
    stage: 21,
    category: "英単語",
  },
  {
    en: "improve",
    ja: "Aを改善する",
    sentence: "We need to improve our communication skills.",
    stage: 21,
    category: "英単語",
  },
  {
    en: "increase",
    ja: "Aを増加させる",
    sentence: "Exercise can increase your energy levels.",
    stage: 21,
    category: "英単語",
  },
  {
    en: "reduce",
    ja: "Aを減らす",
    sentence: "We must reduce carbon emissions to fight climate change.",
    stage: 21,
    category: "英単語",
  },
  {
    en: "expect",
    ja: "Aを期待する",
    sentence: "I expect you to finish the report by Friday.",
    stage: 21,
    category: "英単語",
  },
  {
    en: "suggest",
    ja: "Aを提案する",
    sentence: "She suggested a new approach to the problem.",
    stage: 21,
    category: "英単語",
  },
  {
    en: "describe",
    ja: "Aを描写する",
    sentence: "Can you describe what you saw at the scene?",
    stage: 21,
    category: "英単語",
  },
  {
    en: "allow",
    ja: "Aを許可する",
    sentence: "The teacher allowed students to use dictionaries.",
    stage: 21,
    category: "英単語",
  },
  {
    en: "cause",
    ja: "Aを引き起こす",
    sentence: "Stress can cause serious health problems.",
    stage: 22,
    category: "英単語",
  },
  {
    en: "contain",
    ja: "Aを含む",
    sentence: "This product contains no artificial colors.",
    stage: 22,
    category: "英単語",
  },
  {
    en: "create",
    ja: "Aを作り出す",
    sentence: "Technology has created many new job opportunities.",
    stage: 22,
    category: "英単語",
  },
  {
    en: "develop",
    ja: "Aを発展させる",
    sentence: "The company developed a new software system.",
    stage: 22,
    category: "英単語",
  },
  {
    en: "encourage",
    ja: "Aを奨励する",
    sentence: "Parents should encourage their children to read.",
    stage: 22,
    category: "英単語",
  },
  {
    en: "involve",
    ja: "Aを含む、関わらせる",
    sentence: "The project involves many different departments.",
    stage: 22,
    category: "英単語",
  },
  {
    en: "prevent",
    ja: "Aを防ぐ",
    sentence: "Wearing a mask can prevent the spread of viruses.",
    stage: 22,
    category: "英単語",
  },
  {
    en: "replace",
    ja: "Aを置き換える",
    sentence: "Electric cars will replace gasoline vehicles.",
    stage: 22,
    category: "英単語",
  },
  {
    en: "reveal",
    ja: "Aを明らかにする",
    sentence: "The investigation revealed some surprising facts.",
    stage: 22,
    category: "英単語",
  },
  {
    en: "support",
    ja: "Aを支援する",
    sentence: "The organization supports local communities.",
    stage: 22,
    category: "英単語",
  },
  {
    en: "share",
    ja: "Aを共有する",
    sentence: "Please share your ideas with the rest of the group.",
    stage: 23,
    category: "英単語",
  },
  {
    en: "treat",
    ja: "Aを扱う、治療する",
    sentence: "The doctor treated the patient with antibiotics.",
    stage: 23,
    category: "英単語",
  },
  {
    en: "value",
    ja: "Aを大切にする",
    sentence: "We value your feedback and suggestions.",
    stage: 23,
    category: "英単語",
  },
  {
    en: "focus",
    ja: "Aに集中する",
    sentence: "Let's focus on the most important issues first.",
    stage: 23,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "face",
    ja: "Aに直面する",
    sentence: "We face many challenges in today's world.",
    stage: 23,
    category: "英単語",
  },
  {
    en: "include",
    ja: "Aを含む",
    sentence: "The price includes tax and shipping.",
    stage: 23,
    category: "英単語",
  },
  {
    en: "produce",
    ja: "Aを生産する",
    sentence: "This factory produces over 1,000 cars per day.",
    stage: 23,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "solve",
    ja: "Aを解決する",
    sentence: "Scientists are trying to solve the problem of climate change.",
    stage: 23,
    category: "英単語",
  },
  {
    en: "apply",
    ja: "Aを適用する、応募する",
    sentence: "You can apply for the scholarship online.",
    stage: 24,
    category: "英単語",
  },
  {
    en: "combine",
    ja: "AをBと組み合わせる",
    sentence: "Combine flour and butter to make the dough.",
    stage: 24,
    category: "英単語",
  },
  {
    en: "compare",
    ja: "AをBと比較する",
    sentence: "It is useful to compare different approaches.",
    stage: 24,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "control",
    ja: "Aを制御する",
    sentence: "It is important to control your emotions.",
    stage: 24,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "determine",
    ja: "Aを決定する",
    sentence: "Several factors determine the success of a project.",
    stage: 24,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "express",
    ja: "Aを表現する",
    sentence: "Art allows people to express their feelings.",
    stage: 24,
    category: "英単語",
  },
  {
    en: "form",
    ja: "Aを形成する",
    sentence: "Ice forms when water freezes.",
    stage: 24,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "available",
    ja: "利用可能な",
    sentence: "The product is available in three colors.",
    stage: 25,
    category: "英単語",
  },
  {
    en: "efficient",
    ja: "効率的な",
    sentence: "We need a more efficient way to use energy.",
    stage: 25,
    category: "英単語",
  },
  {
    en: "constant",
    ja: "絶え間ない",
    sentence: "The machine produces a constant noise.",
    stage: 25,
    category: "英単語",
  },
  {
    en: "obvious",
    ja: "明らかな",
    sentence: "It was obvious that she was upset.",
    stage: 25,
    category: "英単語",
  },
  {
    en: "rare",
    ja: "珍しい",
    sentence: "Snow is rare in this part of the country.",
    stage: 25,
    category: "英単語",
  },
  {
    en: "typical",
    ja: "典型的な",
    sentence: "This is a typical example of the problem.",
    stage: 25,
    category: "英単語",
  },
  {
    en: "entire",
    ja: "全体の",
    sentence: "The entire team worked hard on the project.",
    stage: 25,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "current",
    ja: "現在の",
    sentence: "What is the current situation?",
    stage: 26,
    category: "英単語",
  },
  {
    en: "accurate",
    ja: "正確な",
    sentence: "The report must be accurate and complete.",
    stage: 26,
    category: "英単語",
  },
  {
    en: "actual",
    ja: "実際の",
    sentence: "The actual cost was higher than expected.",
    stage: 26,
    category: "英単語",
  },
  {
    en: "additional",
    ja: "追加の",
    sentence: "We need additional information to proceed.",
    stage: 26,
    category: "英単語",
  },
  {
    en: "adequate",
    ja: "十分な",
    sentence: "Make sure you get adequate sleep every night.",
    stage: 26,
    category: "英単語",
  },
  {
    en: "ancient",
    ja: "古代の",
    sentence: "Ancient civilizations built impressive structures.",
    stage: 26,
    category: "英単語",
  },
  {
    en: "basic",
    ja: "基本的な",
    sentence: "Everyone should have basic computer skills.",
    stage: 26,
    category: "英単語",
  },
  {
    en: "brief",
    ja: "短い、簡潔な",
    sentence: "Please give a brief summary of the report.",
    stage: 26,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "common",
    ja: "一般的な、共通の",
    sentence: "It is common to feel nervous before an exam.",
    stage: 26,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "complete",
    ja: "完全な",
    sentence: "Please fill in the complete form.",
    stage: 27,
    category: "英単語",
  },
  {
    en: "concerned",
    ja: "心配している、関係している",
    sentence: "Many people are concerned about climate change.",
    stage: 27,
    category: "英単語",
  },
  {
    en: "conscious",
    ja: "意識している",
    sentence: "She is very conscious of her health.",
    stage: 27,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "consistent",
    ja: "一貫した",
    sentence: "You need to be consistent in your efforts.",
    stage: 27,
    category: "英単語",
  },
  {
    en: "critical",
    ja: "批判的な、重要な",
    sentence: "This is a critical moment in history.",
    stage: 27,
    category: "英単語",
  },
  {
    en: "cultural",
    ja: "文化的な",
    sentence: "Cultural differences can cause misunderstandings.",
    stage: 27,
    category: "英単語",
  },
  {
    en: "direct",
    ja: "直接の",
    sentence: "There is a direct connection between diet and health.",
    stage: 27,
    category: "英単語",
  },
  {
    en: "economic",
    ja: "経済的な",
    sentence: "The country faces serious economic problems.",
    stage: 27,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "eventual",
    ja: "最終的な",
    sentence: "Hard work leads to eventual success.",
    stage: 28,
    category: "英単語",
  },
  {
    en: "digital",
    ja: "デジタルの",
    sentence: "We live in a digital age.",
    stage: 28,
    category: "英単語",
  },
  {
    en: "dramatic",
    ja: "劇的な",
    sentence: "There has been a dramatic increase in smartphone use.",
    stage: 28,
    category: "英単語",
  },
  {
    en: "civil",
    ja: "市民の、礼儀正しい",
    sentence: "Civil rights are protected by law.",
    stage: 28,
    category: "英単語",
  },
  {
    en: "commercial",
    ja: "商業的な",
    sentence: "The film was a commercial success.",
    stage: 28,
    category: "英単語",
  },
  {
    en: "chemical",
    ja: "化学的な",
    sentence: "Chemical reactions produce heat or light.",
    stage: 28,
    category: "英単語",
  },
  {
    en: "dangerous",
    ja: "危険な",
    sentence: "It is dangerous to drive in heavy snow.",
    stage: 28,
    category: "英単語",
  },
  {
    en: "deep",
    ja: "深い",
    sentence: "The lake is very deep in the center.",
    stage: 28,
    category: "英単語",
  },
  {
    en: "dependent",
    ja: "依存している",
    sentence: "Children are dependent on their parents.",
    stage: 28,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "evolution",
    ja: "進化",
    sentence: "Darwin's theory of evolution changed science.",
    stage: 29,
    category: "英単語",
  },
  {
    en: "institution",
    ja: "制度、施設",
    sentence: "Marriage is an important social institution.",
    stage: 29,
    category: "英単語",
  },
  {
    en: "perception",
    ja: "認識、知覚",
    sentence: "Our perception of reality can be influenced by culture.",
    stage: 29,
    category: "英単語",
  },
  {
    en: "contradiction",
    ja: "矛盾",
    sentence: "There is a contradiction between his words and actions.",
    stage: 29,
    category: "英単語",
  },
  {
    en: "ethics",
    ja: "倫理",
    sentence: "Medical ethics is a complex and important field.",
    stage: 29,
    category: "英単語",
  },
  {
    en: "globalization",
    ja: "グローバル化",
    sentence: "Globalization has connected people around the world.",
    stage: 29,
    category: "英単語",
  },
  {
    en: "diversity",
    ja: "多様性",
    sentence: "Diversity in the workplace leads to better results.",
    stage: 29,
    category: "英単語",
  },
  {
    en: "sustainability",
    ja: "持続可能性",
    sentence: "Sustainability is key to protecting our planet.",
    stage: 29,
    category: "英単語",
  },
  {
    en: "distinction",
    ja: "区別",
    sentence: "There is an important distinction between the two concepts.",
    stage: 29,
    category: "英単語",
  },
  {
    en: "consciousness",
    ja: "意識",
    sentence: "Consciousness is one of the great mysteries of science.",
    stage: 30,
    category: "英単語",
  },
  {
    en: "cooperation",
    ja: "協力",
    sentence: "International cooperation is needed to solve global problems.",
    stage: 30,
    category: "英単語",
  },
  {
    en: "efficiency",
    ja: "効率",
    sentence: "Improving efficiency can reduce costs.",
    stage: 30,
    category: "英単語",
  },
  {
    en: "ideology",
    ja: "イデオロギー",
    sentence: "Political ideology shapes government policy.",
    stage: 30,
    category: "英単語",
  },
  {
    en: "implication",
    ja: "含意、影響",
    sentence: "The implications of this decision are serious.",
    stage: 30,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "interpretation",
    ja: "解釈",
    sentence: "There are many possible interpretations of this poem.",
    stage: 30,
    category: "英単語",
  },
  {
    en: "motivation",
    ja: "動機、やる気",
    sentence: "Motivation is essential for achieving your goals.",
    stage: 30,
    category: "英単語",
  },
  {
    en: "obligation",
    ja: "義務",
    sentence: "We have an obligation to protect the environment.",
    stage: 30,
    category: "英単語",
  },
  {
    en: "paradox",
    ja: "逆説",
    sentence: "It is a paradox that technology both connects and isolates us.",
    stage: 30,
    category: "英単語",
  },
  {
    en: "however",
    ja: "しかしながら",
    sentence: "The plan seems good. However, there are some risks.",
    stage: 31,
    category: "英単語",
  },
  {
    en: "therefore",
    ja: "したがって",
    sentence: "She studied hard; therefore, she passed the exam.",
    stage: 31,
    category: "英単語",
  },
  {
    en: "consequently",
    ja: "その結果",
    sentence: "He missed the bus; consequently, he was late.",
    stage: 31,
    category: "英単語",
  },
  {
    en: "furthermore",
    ja: "さらに",
    sentence: "The product is cheap. Furthermore, it is high quality.",
    stage: 31,
    category: "英単語",
  },
  {
    en: "nevertheless",
    ja: "それにもかかわらず",
    sentence: "It was raining. Nevertheless, we went for a walk.",
    stage: 31,
    category: "英単語",
  },
  {
    en: "whereas",
    ja: "一方で",
    sentence: "Some people prefer coffee, whereas others prefer tea.",
    stage: 31,
    category: "英単語",
  },
  {
    en: "simultaneously",
    ja: "同時に",
    sentence: "She was simultaneously excited and nervous.",
    stage: 31,
    category: "英単語",
  },
  {
    en: "otherwise",
    ja: "さもなければ",
    sentence: "Study hard, otherwise you will fail the exam.",
    stage: 31,
    category: "英単語",
  },
  {
    en: "nonetheless",
    ja: "それでもなお",
    sentence: "The task was difficult. Nonetheless, they completed it.",
    stage: 31,
    category: "英単語",
  },
  {
    en: "specifically",
    ja: "具体的に言うと",
    sentence: "I am referring specifically to the second paragraph.",
    stage: 31,
    category: "英単語",
  },
  {
    en: "accordingly",
    ja: "それに応じて",
    sentence: "The situation changed, and we acted accordingly.",
    stage: 32,
    category: "英単語",
  },
  {
    en: "alternatively",
    ja: "あるいは",
    sentence: "You can take the bus, or alternatively, walk.",
    stage: 32,
    category: "英単語",
  },
  {
    en: "conversely",
    ja: "逆に言えば",
    sentence: "Some people gain weight easily; conversely, others do not.",
    stage: 32,
    category: "英単語",
  },
  {
    en: "hence",
    ja: "それゆえ",
    sentence: "She was ill; hence, she could not attend.",
    stage: 32,
    category: "英単語",
  },
  {
    en: "indeed",
    ja: "実際に、確かに",
    sentence: "It was indeed a difficult situation.",
    stage: 32,
    category: "英単語",
  },
  {
    en: "instead",
    ja: "その代わりに",
    sentence: "Don't give up. Try a different approach instead.",
    stage: 32,
    category: "英単語",
  },
  {
    en: "moreover",
    ja: "さらに",
    sentence: "The food was delicious. Moreover, the service was excellent.",
    stage: 32,
    category: "英単語",
  },
  {
    en: "namely",
    ja: "すなわち",
    sentence: "Only one student passed, namely, Taro.",
    stage: 32,
    category: "英単語",
  },
  {
    en: "notably",
    ja: "特に、注目すべきことに",
    sentence: "Several countries, notably Japan, have an aging population.",
    stage: 32,
    category: "英単語",
  },
  {
    en: "despite",
    ja: "〜にもかかわらず",
    sentence: "Despite the rain, the event was a success.",
    stage: 32,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "allocate",
    ja: "Aを割り当てる",
    sentence: "The government allocated funds to education.",
    stage: 33,
    category: "英単語",
  },
  {
    en: "anticipate",
    ja: "Aを予測する",
    sentence: "We anticipate a significant increase in demand.",
    stage: 33,
    category: "英単語",
  },
  {
    en: "characterize",
    ja: "Aを特徴づける",
    sentence: "Honesty characterizes his personality.",
    stage: 33,
    category: "英単語",
  },
  {
    en: "classify",
    ja: "Aを分類する",
    sentence: "Scientists classify organisms into different groups.",
    stage: 33,
    category: "英単語",
  },
  {
    en: "compensate",
    ja: "Aを補償する",
    sentence: "The company compensated workers for their overtime.",
    stage: 33,
    category: "英単語",
  },
  {
  ...
  },
  {
    en: "construct",
    ja: "Aを建設する",
    sentence: "They constructed a new bridge over the river.",
    stage: 33,
    category: "英単語",
  },
  {
    en: "consume",
    ja: "Aを消費する",
    sentence: "Cars consume a large amount of fuel.",
    stage: 33,
    category: "英単語",
  },
  {
    en: "convert",
    ja: "AをBに変換する",
    sentence: "Solar panels convert sunlight into electricity.",
    stage: 34,
    category: "英単語",
  },
  {
    en: "convince",
    ja: "Aを説得する",
    sentence: "He convinced me to change my mind.",
    stage: 34,
    category: "英単語",
  },
  {
    en: "criticize",
    ja: "Aを批判する",
    sentence: "The policy was criticized by many experts.",
    stage: 34,
    category: "英単語",
  },
  {
    en: "distinguish",
    ja: "AをBと区別する",
    sentence: "Can you distinguish between the two options?",
    stage: 34,
    category: "英単語",
  },
  {
    en: "dominate",
    ja: "Aを支配する",
    sentence: "Large companies dominate the market.",
    stage: 34,
    category: "英単語",
  },
  {
    en: "eliminate",
    ja: "Aを排除する",
    sentence: "We must eliminate all forms of discrimination.",
    stage: 34,
    category: "英単語",
  },
  {
    en: "enable",
    ja: "Aを可能にする",
    sentence: "Technology enables us to communicate instantly.",
    stage: 34,
    category: "英単語",
  },
  {
    en: "enhance",
    ja: "Aを高める",
    sentence: "Exercise enhances both physical and mental health.",
    stage: 34,
    category: "英単語",
  },
  {
    en: "fulfill",
    ja: "Aを果たす",
    sentence: "She fulfilled her dream of becoming a doctor.",
    stage: 34,
    category: "英単語",
  },
  {
    en: "abstract",
    ja: "抽象的な",
    sentence: "Abstract concepts can be difficult to understand.",
    stage: 35,
    category: "英単語",
  },
  {
    en: "concrete",
    ja: "具体的な",
    sentence: "Please give a concrete example.",
    stage: 35,
    category: "英単語",
  },
  {
    en: "subjective",
    ja: "主観的な",
    sentence: "Beauty is subjective and varies from person to person.",
    stage: 35,
    category: "英単語",
  },
  {
    en: "rational",
    ja: "合理的な",
    sentence: "We need a rational approach to this problem.",
    stage: 35,
    category: "英単語",
  },
